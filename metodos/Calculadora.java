...
class Calculador{
    ...
    public static void main(String args[]){
        saida(entrada1("Primeiro"), entrada1("Segundo"));
    }

    public static double entrada1(String str){
        System.out.printf("Digite o %s valor:", str);
    ...
    public static void saida(double n1, double n2){
        /*double n1 = valores[0];
        double n2 = valores[1];
        */
